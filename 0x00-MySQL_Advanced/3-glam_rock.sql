...
-- The bands are ranked by their longevity, calculated as the difference between the year they split (or 2022 if they haven't split) and the year they formed.
-- Columns:
